...
class ShoppingThingTest {
    ...
    class Subtotal {
        ...
        void multipleItems_subtotalIsSum() {
            ...
            assertEquals(30.0 + 15.0, cart.subtotal(), EPS);
        }
    }

    @Nested
    @DisplayName("Coupon discounts")
    class CouponDiscounts {

        @Test
        void noCoupon_noCouponDiscount() {
            cart.addItem("X", 10.0, 6, 0.1, "g"); // subtotal 60
            assertEquals(60.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save10_subtotalOver50_tenPercentOff() {
            ...
            assertEquals(60.0 - 6.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save10_subtotalAtBoundary50_flatTwoOff() {
            ...
            cart.setCoupon("SAVE10");
            assertEquals(50.0 - 2.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save10_subtotalBetween20And50_flatTwoOff() {
            ...
            cart.setCoupon("SAVE10");
            assertEquals(30.0 - 2.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save10_subtotalAtBoundary20_noCouponDiscount() {
            ...
            cart.setCoupon("SAVE10");
            assertEquals(20.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save10_subtotalBelow20_noCouponDiscount() {
            ...
            cart.setCoupon("SAVE10");
            assertEquals(10.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save20_subtotalOver100_twentyPercentOff() {
            ...
            // coupon 20% of 120 = 24
            assertEquals(120.0 - 24.0 - 6.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save20_subtotalBetween50And100_tenPercentOff() {
            ...
            cart.setCoupon("SAVE20");
            assertEquals(80.0 - 8.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void save20_subtotalAtOrBelow50_noCouponDiscount() {
            ...
            cart.setCoupon("SAVE20");
            assertEquals(40.0, cart.discountedSubtotal(), EPS);
        }
        ...
        @Test
        void freeshipCoupon_doesNotAffectDiscountedSubtotal() {
            cart.addItem("X", 10.0, 6, 0.1, "g"); // subtotal 60
    ...
    class MemberDiscounts {
        ...
        void goldMember_fifteenPercentOff() {
            ...
            cart.setMember("G");
            assertEquals(90.0 - 13.5, cart.discountedSubtotal(), EPS);
        }
        ...
        void silverMember_fivePercentOff() {
            ...
            cart.setMember("S");
            assertEquals(90.0 - 4.5, cart.discountedSubtotal(), EPS);
        }
        ...
        void nonMemberTierN_noMemberDiscount() {
            cart.addItem("X", 10.0, 9, 0.1, "g"); // subtotal 90
            cart.setMember("N");
            assertEquals(90.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void memberAndCoupon_discountsStack() {
            ...
            assertEquals(90.0 - 9.0 - 13.5, cart.discountedSubtotal(), EPS);
        }
    }
    ...
    class BulkDiscount {
        ...
        void qtyTenAndPriceOverFive_fivePercentOff() {
            ...
            assertEquals(100.0 - 5.0, cart.discountedSubtotal(), EPS);
        }
        ...
        void priceAtBoundaryFive_noBulkDiscount() {
            ...
            assertEquals(50.0, cart.discountedSubtotal(), EPS);
        }

        @Test
        void priceBelowFive_noBulkDiscount() {
            cart.addItem("X", 4.99, 10, 0.1, "g");
            assertEquals(49.9, cart.discountedSubtotal(), EPS);
        }
        ...
        void bulkAppliesPerEligibleItemIndependently() {
            ...
            assertEquals(230.0 - 5.0, cart.discountedSubtotal(), EPS);
        }
    }
    ...
    class Shipping {
        ...
        void emptyCart_shippingIsZero() {
            cart.setCountry("US");
            assertEquals(0.0, cart.shippingCost(), EPS);
        }
        ...
        void usLightPackage_flatFive() {
            ...
            cart.setCountry("US");
            assertEquals(5.0, cart.shippingCost(), EPS);
        }
        ...
        void usMediumPackage_flatTen() {
            cart.addItem("X", 10.0, 1, 3.0, "g");
            cart.setCountry("US");
            assertEquals(10.0, cart.shippingCost(), EPS);
        }
        ...
        void usHeavyPackage_tenPlusTwoPerKgOverFive() {
            ...
            cart.setCountry("US");
            assertEquals(10.0 + 2 * 2.0, cart.shippingCost(), EPS);
        }
        ...
        void caLightPackage_flatEight() {
            cart.addItem("X", 10.0, 1, 0.5, "g");
            cart.setCountry("CA");
            assertEquals(8.0, cart.shippingCost(), EPS);
        }
        ...
        void caMediumPackage_flatFifteen() {
            cart.addItem("X", 10.0, 1, 3.0, "g");
            cart.setCountry("CA");
            assertEquals(15.0, cart.shippingCost(), EPS);
        }
        ...
        void caHeavyPackage_fifteenPlusThreePerKgOverFive() {
            cart.addItem("X", 10.0, 1, 7.0, "g");
            cart.setCountry("CA");
            assertEquals(15.0 + 3 * 2.0, cart.shippingCost(), EPS);
        }
        ...
        void internationalLight_flatTwenty() {
            cart.addItem("X", 10.0, 1, 0.5, "g");
            cart.setCountry("UK");
            assertEquals(20.0, cart.shippingCost(), EPS);
        }
        ...
        void internationalMedium_flatThirtyFive() {
            cart.addItem("X", 10.0, 1, 3.0, "g");
            cart.setCountry("UK");
            assertEquals(35.0, cart.shippingCost(), EPS);
        }
        ...
        void internationalHeavy_thirtyFivePlusFivePerKgOverFive() {
            cart.addItem("X", 10.0, 1, 7.0, "g");
            cart.setCountry("UK");
            assertEquals(35.0 + 5 * 2.0, cart.shippingCost(), EPS);
        }
        ...
        void expressShipping_multipliesByOnePointFive() {
            ...
            assertEquals(10.0 * 1.5, cart.shippingCost(), EPS);
        }
        ...
        void totalWeight_sumsAcrossAllItems() {
            ...
            cart.setCountry("US");
            assertEquals(10.0 + 2 * 1.0, cart.shippingCost(), EPS);
        }
    }
    ...
    class Tax {
        ...
        void tax_isComputedOnDiscountedSubtotalNotRawSubtotal() {
            cart.addItem("X", 10.0, 6, 0.1, "g"); // subtotal 60
            cart.setCoupon("SAVE10");               // 10% off -> discountedSubtotal 54
            cart.setCountry("US");
    ...
    class Total {
        ...
        void total_isDiscountedPlusShippingPlusTax() {
            ...
            // discountedSubtotal = 90 - 9 - 4.5 = 76.5
            // shippingCost = 10
            // tax  = 76.5 * 0.07 = 5.355
